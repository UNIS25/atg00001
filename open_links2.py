...
# ✅ FORCE SELENIUM TO USE YOUR LOGGED-IN CHROME PROFILE
chrome_options = Options()
chrome_options.add_argument("--window-size=1280,800")  # Set window size
chrome_options.binary_location = "C:/Program Files/Google/Chrome/Application/chrome.exe"

# ✅ USE YOUR CHROME PROFILE PATH (Already Logged In)
chrome_options.add_argument("user-data-dir=C:/Users/adswi/AppData/Local/Google/Chrome/User Data")
chrome_options.add_argument("profile-directory=Default")  # This is your default profile

# ✅ USE CHROME IN NORMAL MODE WITH YOUR LOGGED-IN SESSION
